...
public class DestinationMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Weather weather = (Weather) getIntent().getSerializableExtra(de.tum.in.repobruegge.pom17aprilsnow.flightapp.presentation.activities.FlightDetailsActivity.WEATHER);

        city = getIntent().getStringExtra(de.tum.in.repobruegge.pom17aprilsnow.flightapp.presentation.activities.FlightDetailsActivity.DESTINATION_CITY);
        String localTime = getIntent().getStringExtra(de.tum.in.repobruegge.pom17aprilsnow.flightapp.presentation.activities.FlightDetailsActivity.LOCAL_TIME_CITY);

...
import parccc.Model.FlightConverter;
...
public class AvailableFlightListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<Flight> arrayDestintyAdapter = new de.tum.in.repobruegge.pom17aprilsnow.flightapp.presentation.adapters.FlightArrayAdapter(this, destinityFlights);
        ...
        ArrayAdapter<Flight> arrayReturnAdapter = new de.tum.in.repobruegge.pom17aprilsnow.flightapp.presentation.adapters.FlightArrayAdapter(this, returnFlights);
    ...
    private final View.OnClickListener addToTripButtonClicked =
            new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(de.tum.in.repobruegge.pom17aprilsnow.flightapp.presentation.activities.TripListActivity.CURRENT_TRIP_ID, tripId);
    ...
    private boolean saveFlight(Flight selectedFlight) {
        ...
        dumpedFlight.put(de.tum.in.repobruegge.pom17aprilsnow.flightapp.Model.database.DatabaseDescription.Flight.COLUMN_TRIP_ID, tripId.toString());

        // use Activity's ContentResolver to invoke
        // insert on the FlightContentProvider
        Uri newContactUri = getContentResolver().insert(de.tum.in.repobruegge.pom17aprilsnow.flightapp.Model.database.DatabaseDescription.Flight.CONTENT_URI, dumpedFlight);

        ...
        try {
           ...
           //MUC - TXL , 2017-07-13
            ...
            if (flightsReturn != null && flightsReturn !=null) {
                Intent intent =  new Intent(getApplicationContext(), de.tum.in.repobruegge.pom17aprilsnow.flightapp.presentation.activities.AvailableFlightListActivity.class);

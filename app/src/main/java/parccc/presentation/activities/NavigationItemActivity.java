...
public abstract class NavigationItemActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.main) {
            intent = de.tum.in.repobruegge.pom17aprilsnow.flightapp.presentation.activities.TripListActivity.newIntent(NavigationItemActivity.this);
        } else if (id == R.id.safety_instructions) {
            intent = de.tum.in.repobruegge.pom17aprilsnow.flightapp.presentation.activities.SafetyInstructionsActivity.newIntent(NavigationItemActivity.this);
